...
The code for the empirical study is contained in EmpiricalStudy-Final.R and uses the RE Europe dataset introduced in Jensen, T., Pinson, P. RE-Europe, a large-scale dataset for modeling a highly renewable European electricity system. Sci Data 4, 170175 (2017). https://doi.org/10.1038/sdata.2017.175.
